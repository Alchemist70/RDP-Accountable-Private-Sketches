...
Usage:
    python scripts/generate_aps_plots_fallback.py --alloc paper_figures/aps_plus_convex_tight.json --steps 100 --delta 1e-6 --outdir paper_figures
...
def approx_epsilon_from_sigma(sigma, steps, delta, orders=None):
    # RDP for Gaussian: R_\u03b1(\alpha) = \alpha / (2 sigma^2) per mechanism
